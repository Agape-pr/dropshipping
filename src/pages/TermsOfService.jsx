  ...
  return (
    <div className="policy-container">
      ...
      <div className="policy-content">
        ...
        <p>
          By accessing or using isooko ("we," "us," or "our"), 
        ...
        <p>
          ...
          on isooko's website for personal, non-commercial transitory viewing only.
        </p>
        <p>This is the grant of a license, not a transfer of title, and under this license you may not:</p>
        <ul>
          <li>modify or copy the materials;</li>
          <li>use the materials for any commercial purpose, or for any public display (commercial or non-commercial);</li>
          <li>attempt to decompile or reverse engineer any software contained on isooko's website;</li>
        ...
        <h2>3. Disclaimer</h2>
        <p>
          The materials on isooko's website are provided on an 'as is' basis. We make no warranties, 
        ...
        <h2>4. Limitations</h2>
        <p>
          In no event shall isooko or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on isooko's website.
        </p>
        ...
        <p>
          The materials appearing on isooko's website could include technical, typographical, or photographic errors. 
